...
- **Fast Feedback Core Suite:** Default unit tests must run fast to maintain quick development cycles. Isolate heavy end-to-end simulations, full model retraining, or long-horizon replays into dedicated integration/slow suites.
...
- **Boundary Mocking:** Mock external network boundaries, broker/exchange data APIs, hardware I/O, and non-deterministic clock/system interfaces. Never mock internal business logic or transform tests into meaningless mock-chains.
