...
LAYER_RANK['src/marketdata/toss_program_trades.py'] = 1
LAYER_RANK['src/cli/toss_program_trades_backfill.py'] = 7
LAYER_RANK['src/marketdata/snapshot_contracts.py'] = 1
LAYER_RANK['src/marketdata/snapshot_schema.py'] = 1
LAYER_RANK['src/marketdata/snapshot_plan.py'] = 1
LAYER_RANK['src/marketdata/snapshot_validation.py'] = 1
LAYER_RANK['src/marketdata/bar_validation.py'] = 1
LAYER_RANK['src/marketdata/bar_store.py'] = 1
LAYER_RANK['src/marketdata/partitioned_store.py'] = 1
LAYER_RANK['src/marketdata/program_trade_service.py'] = 4
LAYER_RANK['src/cli/toss_program_trades_sync.py'] = 7
...
LAYER_RANK['src/orchestration/trading_day_gate.py'] = 5
LAYER_RANK['src/core/symbols.py'] = 0
LAYER_RANK['src/core/paths.py'] = 0
LAYER_RANK['src/storage/market_phase.py'] = 2
LAYER_RANK['src/storage/normalization.py'] = 2
LAYER_RANK['src/storage/quality_ls.py'] = 2
LAYER_RANK['src/storage/quality_kis.py'] = 2
LAYER_RANK['src/brokers/kis/rate.py'] = 2
LAYER_RANK['src/brokers/kis/auth.py'] = 2
LAYER_RANK['src/brokers/kis/http.py'] = 2
LAYER_RANK['src/brokers/kis/data.py'] = 2
LAYER_RANK['src/brokers/kis/trading.py'] = 2
LAYER_RANK['src/core/log_format.py'] = 0
LAYER_RANK['src/core/alerts.py'] = 0
LAYER_RANK['src/core/session_anchors.py'] = 0
